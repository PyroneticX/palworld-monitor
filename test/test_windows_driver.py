...
# Test WindowsProcessManager. This test its main methods are working properly.
def main():
    driver = WindowsProcessManager()
    
    # Test with a simple command that we can control
    test_exe = 'python'
    test_args = 'test_sleep.py'
    
    print('>>> Testing WindowsProcessManager...')
