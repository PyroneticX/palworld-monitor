"""
Extended tests for AutoStartManager covering packet detection, socket handling,
...
class TestAutoStartSubscriptions:
    """Test suite for event subscriptions."""

    def test_init_subscribes_to_server_events(self):
