...
class TestVerifyPassword:
    ...
    @pytest.mark.parametrize("input_user,input_pass,expected_user,expected_pass,expected", [
    ...
    def test_verify_password(self, input_user, input_pass, expected_user, expected_pass, expected):
        """Test password verification with various scenarios."""
        assert verify_password(input_user, input_pass, expected_user, expected_pass) == expected
